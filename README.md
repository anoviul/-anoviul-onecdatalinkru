...
| Файл | Для чего |
|---|---|
| `onecdatalink_v0.9.28 (управляемые формы, УТ 11.4, УТ 11.5, УНФ, КА 2, ERP 2).epf` | управляемые формы, платформа 8.3.6 и новее: УТ 11.4 и 11.5, УНФ, КА 2, ERP 2, БП 3 |
...
## Серверная часть: своя или готовая

Обработка - клиент простого открытого протокола: она забирает задания
исходящим HTTP и возвращает результаты, все методы видны в ее коде. Серверную
часть можно написать самостоятельно под свои задачи - очередь заданий, выдача
ключей и прием результатов реализуются любым стеком. А можно воспользоваться
готовой - [onecdatalink.ru](https://onecdatalink.ru).
