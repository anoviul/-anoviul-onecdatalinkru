...
| Файл | Для чего |
|---|---|
| `onecdatalink_v0.9.29 (управляемые формы, УТ 11.4, УТ 11.5, УНФ, КА 2, ERP 2).epf` | управляемые формы, платформа 8.3.6 и новее: УТ 11.4 и 11.5, УНФ, КА 2, ERP 2, БП 3 |
| `onecdatalink_v0.9.29 (старые платформы 8.3.5, УТ 11.1).epf` | старые платформы 8.3.5.x, например УТ 11.1, прямое подключение |
| `onecdatalink_v0.9.29 (старые платформы 8.3.5, УТ 11.1, через прокси).epf` | то же для старых Windows без TLS 1.2: рядом ставится локальный прокси |
| `onecdatalink_v0.9.29 (обычные формы, УПП 1.3, УТ 10.3, КА 1.1).epf` | обычное приложение: УПП 1.3, УТ 10.3, КА 1.1. Обмен идёт из открытой формы |
| `onecdatalink_v0.9.29 (обычные формы, УПП 1.3, УТ 10.3, КА 1.1, через прокси).epf` | обычное приложение на старых Windows без TLS 1.2, через локальный прокси |
...
1. «Файл» - «Открыть», выбрать `onecdatalink_v0.9.29 (управляемые формы, УТ 11.4, УТ 11.5, УНФ, КА 2, ERP 2).epf`. Или добавить в
...
`onecdatalink_v0.9.29 (старые платформы 8.3.5, УТ 11.1).epf` - она подключается напрямую,
...
`onecdatalink_v0.9.29 (старые платформы 8.3.5, УТ 11.1, через прокси).epf` - в ней вшит адрес
`http://127.0.0.1:8080`.
...
`onecdatalink_v0.9.29 (обычные формы, УПП 1.3, УТ 10.3, КА 1.1).epf`. Внутри тот же обмен, разница только
